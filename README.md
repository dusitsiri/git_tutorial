...
![edit branch without touching](https://github.com/dusitsiri/git_tutorial_command_line/master/how to edit main branch without touch it directly (friendly)/merge.png)